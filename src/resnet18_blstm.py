...
def model(is_training=True, img_size=(280, 32), num_classes=5991, max_label_length=10):
    ...
    conv_branch = Conv2D(32, (3, 3), strides=(1, 1), use_bias=False, name='res2a_conv1')(conv_branch)
    ...
    conv_branch = Conv2D(64, (3, 3), strides=(1, 1), use_bias=False, name='res2a_conv2')(conv_branch)
    conv_branch = BatchNormalization(name='res2a_BN2')(conv_branch)
    # short cut
    short_cut = Conv2D(64, (1, 1), strides=(1, 1), name='res2a_sc')(x)
    ...
    conv_branch = Conv2D(32, (3, 3), strides=(1, 1), use_bias=False, name='res2b_conv1')(conv_branch)
    ...
    conv_branch = Conv2D(64, (3, 3), strides=(1, 1), use_bias=False, name='res2b_conv2')(conv_branch)
    ...
    conv_branch = Conv2D(32, (3, 3), strides=(2, 2), use_bias=False, name='res3a_conv1')(conv_branch)
    ...
    conv_branch = Conv2D(64, (3, 3), strides=(1, 1), use_bias=False, name='res3a_conv2')(conv_branch)
    conv_branch = BatchNormalization(name='res3a_BN2')(conv_branch)
    # short cut
    short_cut = Conv2D(64, (1, 1), strides=(2, 2), name='res3a_sc')(x)
    ...
    conv_branch = Conv2D(64, (3, 3), strides=(1, 1), use_bias=False, name='res3b_conv1')(conv_branch)
    ...
    conv_branch = Conv2D(64, (3, 3), strides=(1, 1), use_bias=False, name='res3b_conv2')(conv_branch)
    ...
    conv_branch = Conv2D(64, (3, 3), strides=(1, 1), use_bias=False, name='res4a_conv1')(conv_branch)
    ...
    conv_branch = Conv2D(128, (3, 3), strides=(1, 1), use_bias=False, name='res4a_conv2')(conv_branch)
    conv_branch = BatchNormalization(name='res4a_BN2')(conv_branch)
    # short cut
    short_cut = Conv2D(128, (1, 1), strides=(1, 1), name='res4a_sc')(x)
    ...
    conv_branch = Conv2D(64, (3, 3), strides=(1, 1), use_bias=False, name='res4b_conv1')(conv_branch)
    ...
    conv_branch = Conv2D(128, (3, 3), strides=(1, 1), use_bias=False, name='res4b_conv2')(conv_branch)
    ...
    # RNN part
    y = Bidirectional(LSTM(256, return_sequences=True), name='BLSTM1')(rnn_input)
    y = BatchNormalization(name='rnn_BN')(y)
    y = Bidirectional(LSTM(256, return_sequences=True), name='BLSTM2')(y)
